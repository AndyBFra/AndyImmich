...
**Achtung:** Nach einem Neustart von Andyserver startet Colima automatisch (LaunchAgent), die Container selbst aber noch **nicht** — dafür fehlt aktuell noch ein Autostart-Mechanismus (siehe TODO).
...
- [ ] **Docker-Compose-Autostart** nach Reboot einrichten — z.B. weiterer LaunchAgent, der nach Colima `docker-compose up -d` ausführt
